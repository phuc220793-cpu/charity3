...
async function main() {
  const campaigns = [
    { title: "CHUNG TAY VÌ TRẺ EM VÙNG CAO", target: "0.10", days: 30 },
    { title: "QUỸ PHẪU THUẬT TIM CHO TRẺ EM NGHÈO", target: "0.10", days: 45 },
    { title: "HỖ TRỢ ĐỒNG BÀO LŨ LỤT MIỀN TRUNG", target: "0.10", days: 60 },
  ];
